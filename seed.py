...
def seed(db):
    ...
    db.session.add(UserPost(userId=santiago.id, postId=post1.id))
    db.session.add(UserPost(userId=thomas.id, postId=post1.id))
    db.session.commit()
    ...
    db.session.add(UserPost(userId=santiago.id, postId=post2.id))
    db.session.commit()
    ...
    db.session.add(UserPost(userId=santiago.id, postId=post3.id))
    db.session.add(UserPost(userId=ashanti.id, postId=post3.id))
    db.session.commit()
    ...
    db.session.add(UserPost(userId=ashanti.id, postId=post4.id))
    db.session.commit()
